<template>
  <div :class="headerClass" class="sticky top-0 z-[999] shadow-sm">
    <div
      class="container flex justify-between py-3 sm:py-4 lg:py-3 xl:py-5 sm:items-center font-bold text-lg sm:text-2xl"
    >
      <router-link to="/" id="headerLogo" class="flex items-center">
        <svg
          class="absolute screen-500:static w-[80px] h-[30px] md:w-[130px] md:h-[45px] lg:w-[210px] lg:h-[60px]"
          viewBox="0 0 251 93"
          fill="none"
      ...
      <!-- Main Header Links  -->
      <ul
        class="flex items-center space-x-3 md:space-x-4 lg:space-x-5 xl:space-x-6 2xl:space-x-7 text-main-text"
      >
        <li class="">
          <router-link
            to="/"
            class="hidden md:inline-block text-base sm:text-lg lg:text-xl"
            >Əsas Səhifə</router-link
          >
        </li>
        <!-- ---------- ABOUT US ----------  -->
        <li class="headerParent relative group">
          <router-link
            ...
            class="hidden md:inline-block cursor-pointer text-base sm:text-lg lg:text-xl about-header"
          >
            <span>Haqqımızda</span>
            <i
              class="aboutFa fa-solid fa-angle-down ml-1 transition-transform duration-300 hidden lg:inline-block"
            ></i>
          </router-link>
          <ul
            class="headerDropdown absolute top-8 -right-0 lg:-right-32 z-30 bg-white min-w-[320px] py-3 xl:py-5 shadow-xl rounded-xl opacity-0 invisible transition-all duration-500 group-hover:!top-9 group-hover:opacity-100 group-hover:visible border border-t-primary dropDownElement"
          >
            <li class="px-5">
              <router-link
                :to="{ name: 'our-history' }"
            ...
            <li class="px-5 mediaParent">
              <router-link
                to="/az/haqqımızda/mediada-biz/xəbərlər"
                class="cursor-pointer flex w-full h-full justify-between text-[18px]"
              >
                <span>Mediada Biz</span>
                <span><i class="mediaFa fa-solid fa-angle-down"></i></span>
              </router-link>
              <ul
                class="mediaDropdown shadow-xl rounded-xl border border-t-primary hidden md:block dropDownElement"
              >
                <li class="px-5">
                  <router-link
                    :to="{ name: 'all-news' }"
                ...
                <li class="px-5 galleryParent">
                  <router-link
                    to="/az/haqqımızda/mediada-biz/qalereya/"
                    class="cursor-pointer flex w-full h-full justify-between text-[18px]"
                  >
                    <span>Qalereya</span>
                    <span
                      ><i class="galleryFa fa-solid fa-angle-down"></i
                    ></span>
                  </router-link>
                  <ul
                    class="galleryDropdown shadow-xl rounded-xl border border-t-primary"
                  >
                    <li class="px-5">
                      <router-link
                        :to="{ name: 'photos-view' }"
            ...
            <li class="px-5">
              <router-link
                :to="{ name: 'quality-policy' }"
                class="block w-full h-full text-[18px]"
                >Keyfiyyət siyasəti</router-link
              >
            </li>
            <li class="px-5">
              <router-link
        ...
        <li class="headerParent relative group">
          <router-link
            ...
            active-class="router-link-active"
            class="hidden md:inline-block cursor-pointer text-base sm:text-lg lg:text-xl doctors-header"
          >
            <span>Həkimlər</span>
            <i
              class="doctorsFa fa-solid fa-angle-down ml-1 transition-transform duration-300 hidden lg:inline-block"
            ></i>
          </router-link>
          <ul
            class="dropDownElement headerDropdown absolute top-8 -right-52 z-30 bg-white min-w-[320px] py-3 xl:py-5 shadow-xl rounded-xl opacity-0 invisible transition-all duration-500 group-hover:!top-9 group-hover:opacity-100 group-hover:visible border border-t-primary"
          >
            <li class="px-5">
              <router-link
                :to="{ name: 'doctors' }"
        ...
        <li class="headerParent relative group">
          ...
          >
            <span>Bölmələr</span>
            <i
              class="departmentsFa fa-solid fa-angle-down ml-1 transition-transform duration-300 hidden lg:inline-block"
            ></i>
          </button>
          <ul
            class="dropDownElement headerDropdown absolute top-8 -right-14 xl:-right-40 z-30 bg-white py-3 xl:py-5 shadow-xl rounded-xl opacity-0 invisible transition-all duration-500 group-hover:!top-9 group-hover:opacity-100 group-hover:visible border border-t-primary"
          >
            <!-- Pediatrics -->
              ...
              >
                <router-link
                  ...
                  :class="{
                    'text-primary':
                      isDepartmentRoute &&
                      route.params.slug === department.slug,
                  }"
                  class="block w-full h-full text-[18px]"
                >
                  {{ department.name }}
        ...
        <li class="headerParent relative group">
          ...
          >
            ...
            <i
              class="medicalsFa fa-solid fa-angle-down ml-1 transition-transform duration-300"
            ></i>
          </button>
          <!-- MEDİCAL SERVİCES (HEADER)  -->
          <ul
            class="dropDownElement headerDropdown absolute top-8 -right-44 z-30 bg-white min-w-[320px] py-3 xl:py-5 shadow-xl rounded-xl opacity-0 invisible transition-all duration-500 group-hover:!top-9 group-hover:opacity-100 group-hover:visible border border-t-primary"
          >
        ...
        <li class="">
          <router-link
            :to="{ name: 'check-up' }"
            class="hidden xl:inline-block cursor-pointer text-base sm:text-lg lg:text-xl"
            >Check Up</router-link
          >
        </li>
      </ul>
      ...
      <div class="flex items-center">
        ...
        <div
          class="headerParent relative group flex items-center justify-center"
        >
          <!-- Burger icon-ə @click əlavə olunur -->
          <div
            @click="toggleBurger"
            class="ml-3 w-[30px] h-[20px] md:w-[40px] md:h-[30px] lg:w-[42px] lg:h-[32px] flex flex-col justify-around items-end cursor-pointer"
          >
            <span
              class="w-10/12 h-[4px] md:h-[5px] lg:h-[6px] rounded-md bg-primary"
            ></span>
            <span
              class="w-full h-[4px] md:h-[5px] lg:h-[6px] rounded-md bg-primary"
            ></span>
            <span
              class="w-10/12 h-[4px] md:h-[5px] lg:h-[6px] rounded-md bg-primary"
            ></span>
          ...
          <ul
            class="dropDownElement headerDropdown hidden lg:block absolute top-8 right-0 z-30 bg-white min-w-[300px] py-3 xl:py-5 shadow-xl rounded-xl opacity-0 invisible transition-all duration-500 group-hover:!top-9 group-hover:opacity-100 group-hover:visible cursor-pointer text-main-text"
          >
            <!-- Əvvəlki mobil elementlər (burger içindəki) -->
            <li class="lg:hidden px-5">
              <router-link
                :to="{ name: 'doctors' }"
                class="sm:hidden text-base sm:text-lg lg:text-xl"
                >Həkimlər</router-link
              >
            </li>
            <li class="lg:hidden px-5">
              <a href="#" class="w-full h-full text-base sm:text-lg lg:text-xl"
                >Bölmələr</a
              >
            </li>
            ...
            <li class="px-5">
              <router-link
                :to="{ name: 'check-up' }"
                class="lg:hidden w-full h-full text-base sm:text-lg lg:text-xl"
                >Check Up</router-link
              >
            </li>
            ...
            <li class="px-5 onlineParent relative">
              <router-link
                to="/az/online-xidmətlər"
                class="w-full h-full text-base sm:text-lg lg:text-xl"
              >
                <span>Onlayn Xidmətlər</span>
                <span
                  ><i class="onlineFa fa-solid fa-angle-down ml-1"></i
                ></span>
              </router-link>
        ...
        <div class="relative ml-3">
          ...
          <template v-if="!authStore.isLoggedIn">
            <i
              class="fa-solid fa-right-to-bracket text-2xl md:text-3xl text-[#ef7c00] cursor-pointer"
              @click="toggleModal"
            ></i>
          </template>
          ...
          <template v-else>
            <div class="headerParent relative">
  <div
    class="flex items-center cursor-pointer"
    @click="toggleProfileDropdown"
  >
    <i class="fa-solid fa-user-circle text-2xl md:text-3xl text-[#ef7c00]"></i>
    <span class="ml-2 hidden md:inline text-sm text-primary">
      {{ authStore.username }}
    </span>
  </div>
  ...
  <ul
    ...
    class="headerDropdown absolute top-8 right-0 z-30 bg-white w-48 py-3 shadow-xl rounded-xl border border-t-primary"
  >
    <li class="mb-2 px-4">
      <router-link
        :to="{ name: 'profile' }"
    ...
    <li class="px-4">
      <button
        @click="logout"
        class="exitBtn flex w-full items-center py-1 text-red-500"
      >
      ...
      >
        <div class="container mx-auto py-3 xl:py-5 px-4">
          <div class="flex justify-between items-center mb-5">
            ...
            <button @click="toggleBurger" class="text-2xl font-bold">
              &times;
            </button>
          </div>
          <ul class="space-y-2">
            ...
            <li class="md:hidden">
              <div
                @click="toggleBurgerDropdown('haqqimizda_mobile')"
                class="flex justify-between items-center cursor-pointer text-lg sm:text-xl"
              >
                <span>Haqqımızda</span>
                <i
                  class="fa-solid fa-angle-down transition-transform duration-300"
                  :class="{ 'rotate-180': burgerDropdowns.haqqimizda_mobile }"
                ></i>
              </div>
              <ul
                v-if="burgerDropdowns.haqqimizda_mobile"
                class="dropDownElement pl-2 space-y-1"
              >
                <li>
                  <router-link
                    :to="{ name: 'our-history' }"
                ...
                <li>
                  ...
                  >
                    ...
                    <i
                      class="fa-solid fa-angle-down transition-transform duration-300"
                      :class="{
                        'rotate-180': burgerDropdowns.mediadaBiz_mobile,
                      }"
                    ></i>
                  </div>
                  <ul
                    v-if="burgerDropdowns.mediadaBiz_mobile"
                    ...
                    <li>
                      ...
                      >
                        ...
                        <i
                          class="fa-solid fa-angle-down transition-transform duration-300"
                          :class="{
                            'rotate-180': burgerDropdowns.gallery_mobile,
                          }"
                        ></i>
                      </div>
                      <ul
                        v-if="burgerDropdowns.gallery_mobile"
                        class="pl-2 space-y-2"
                      >
                        <li>
                          <router-link
            ...
            <li class="md:hidden">
              <div
                @click="toggleBurgerDropdown('hekimler_mobile')"
                class="flex justify-between items-center cursor-pointer text-lg"
              >
                <span>Həkimlər</span>
                <i
                  class="fa-solid fa-angle-down transition-transform duration-300"
                  :class="{ 'rotate-180': burgerDropdowns.hekimler_mobile }"
                ></i>
              </div>
              <ul
                v-if="burgerDropdowns.hekimler_mobile"
                class="dropDownElement pl-2 space-y-1"
              >
                <li>
                  <router-link
            ...
            <li class="md:hidden">
              <div
                :class="{ 'text-primary': isDepartmentRoute }"
                @click="toggleBurgerDropdown('bolmeler_mobile')"
                class="flex justify-between items-center cursor-pointer text-lg"
              >
                <span>Bölmələr</span>
                <i
                  class="fa-solid fa-angle-down transition-transform duration-300"
                  :class="{ 'rotate-180': burgerDropdowns.bolmeler_mobile }"
                ></i>
              </div>
              <ul
                v-if="burgerDropdowns.bolmeler_mobile"
                class="dropDownElement pl-2 space-y-1"
              >
                ...
                <li>
                  ...
                  >
                    ...
                    <i
                      class="fa-solid fa-angle-down transition-transform duration-300"
                      :class="{
                        'rotate-180': burgerDropdowns.pediatrics_mobile,
                      }"
                    ></i>
                  </div>
                  <!-- Dinamik Pediatriya -->
                  <ul
                    v-if="burgerDropdowns.pediatrics_mobile"
                ...
                <li>
                  ...
                  >
                    ...
                    <i
                      class="fa-solid fa-angle-down transition-transform duration-300"
                      :class="{
                        'rotate-180': burgerDropdowns.cerrahiyye_mobile,
                      }"
                    ></i>
                  </div>
                  <!-- Dinamik Cərrahiyə -->
            ...
            <li>
              <router-link
                :to="{ name: 'check-up' }"
                @click="toggleBurger"
                class="lg:hidden w-full h-full text-lg lg:text-xl"
                >Check Up</router-link
              >
            </li>
            <!-- CheckUP (SİDEBAR) END -->
            ...
            <li class="lg:hidden">
              <div
                :class="{ 'text-primary': isMedServiceRoute }"
                @click="toggleBurgerDropdown('tibbiXidmetler_mobile')"
                class="flex justify-between items-center cursor-pointer text-lg lg:text-xl"
              >
                <span>Tibbi xidmətlər</span>
                <i
                  class="fa-solid fa-angle-down transition-transform duration-300"
                  :class="{
                    'rotate-180': burgerDropdowns.tibbiXidmetler_mobile,
                  }"
                ></i>
              </div>
              <ul
                v-if="burgerDropdowns.tibbiXidmetler_mobile"
                class="dropDownElement pl-2 space-y-1"
              >
            ...
            <li>
              <div
                @click="toggleBurgerDropdown('onlaynXidmetler_mobile')"
                class="flex justify-between items-center cursor-pointer text-lg"
              >
                <span>Onlayn Xidmətlər</span>
                <i
                  class="fa-solid fa-angle-down transition-transform duration-300"
                  :class="{
                    'rotate-180': burgerDropdowns.onlaynXidmetler_mobile,
                  }"
                ></i>
              </div>
              <ul
                v-if="burgerDropdowns.onlaynXidmetler_mobile"
                class="dropDownElement pl-2 space-y-1"
              >
  ...
  try {
    ...
    if (doctorResponse.data && doctorResponse.data.results) {
      doctorResults = doctorResponse.data.results.filter((doctor) => {
        ...
        const degreeMatch =
          (doctor.degree &&
            doctor.degree.toLowerCase().includes(searchText.toLowerCase())) ||
          (doctor.degree_az &&
            doctor.degree_az
              .toLowerCase()
              .includes(searchText.toLowerCase())) ||
          (doctor.degree_ru &&
            doctor.degree_ru.toLowerCase().includes(searchText.toLowerCase()));

        const categoryMatch =
          (doctor.category &&
            doctor.category.toLowerCase().includes(searchText.toLowerCase())) ||
          (doctor.category_ru &&
            doctor.category_ru
              .toLowerCase()
              .includes(searchText.toLowerCase())) ||
        ...
        const positionMatch =
          (doctor.position &&
            doctor.position.toLowerCase().includes(searchText.toLowerCase())) ||
          (doctor.position_ru &&
            doctor.position_ru
              .toLowerCase()
              .includes(searchText.toLowerCase())) ||
